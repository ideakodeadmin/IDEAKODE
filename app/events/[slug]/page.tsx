...
import { ArrowLeft, ArrowRight, Calendar, MapPin, Clock, Users, Trophy, Code2, ChevronDown, CheckCircle2, Sparkles } from 'lucide-react';
import { type Event, events, getEventBySlug } from '@/data';
    ...
    return (
      <main className="flex min-h-screen items-center justify-center px-5 text-center">
        <div>
          ...
          <h1 className="mt-3 font-display text-4xl font-bold text-white">Event not found</h1>
          <Link href="/" className="mt-6 inline-flex text-sm font-semibold text-gold-400 hover:text-gold-300">Back to IDEAKODE</Link>
        </div>
      </main>
    );
  }
